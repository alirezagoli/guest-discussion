...
/**
 * Provides the local service interface for Title. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Alireza
 * @see TitleLocalServiceUtil
...
public interface TitleLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TitleLocalServiceUtil} to access the title local service. Add custom service methods to {@link ir.ac.iut.sccportal.guestdiscussion.service.impl.TitleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
