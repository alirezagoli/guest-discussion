 ...
 * {@link ir.ac.iut.sccportal.guestdiscussion.service.impl.CommentLocalServiceImpl} and is the
...
public class CommentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link ir.ac.iut.sccportal.guestdiscussion.service.impl.CommentLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static ir.ac.iut.sccportal.guestdiscussion.model.Comment addComment(
	...
	*/
	public static ir.ac.iut.sccportal.guestdiscussion.model.Comment createComment(
		long commentId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ir.ac.iut.sccportal.guestdiscussion.model.Comment deleteComment(
		long commentId)
	...
	*/
	...
	public static ir.ac.iut.sccportal.guestdiscussion.model.Comment fetchComment(
		long commentId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ir.ac.iut.sccportal.guestdiscussion.model.Comment getComment(
		long commentId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<ir.ac.iut.sccportal.guestdiscussion.model.Comment> getComments(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ir.ac.iut.sccportal.guestdiscussion.model.Comment updateComment(
		ir.ac.iut.sccportal.guestdiscussion.model.Comment comment)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ir.ac.iut.sccportal.guestdiscussion.model.Comment addComment(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addComment(groupId, companyId, modifiedDate, parentId,
			commentText, guestName, likeCount, titleId, verified, hasChild,
			parentName, guestEmailAddress, guestEmailNotification);
	}

	public static java.util.List<ir.ac.iut.sccportal.guestdiscussion.model.Comment> getCommentsByParentId_TitleId_Verified(
		long parentId, long titleId, boolean verified)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getCommentsByParentId_TitleId_Verified(parentId, titleId,
			verified);
	}

	public static java.util.List<ir.ac.iut.sccportal.guestdiscussion.model.Comment> getCommentsByTitleId_Verified(
		long titleId, boolean verified)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCommentsByTitleId_Verified(titleId, verified);
	}

	public static java.util.List<ir.ac.iut.sccportal.guestdiscussion.model.Comment> getCommentsByTitleId(
		long titleId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCommentsByTitleId(titleId);
	}

	public static void deleteCommentsByTitleId(long titleId)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteCommentsByTitleId(titleId);
	}
