...
/**
 * Provides the remote service interface for PortletTitle. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Alireza
 * @see PortletTitleServiceUtil
...
public interface PortletTitleService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PortletTitleServiceUtil} to access the portlet title remote service. Add custom service methods to {@link ir.ac.iut.sccportal.guestdiscussion.service.impl.PortletTitleServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
