...
package ir.ac.iut.sccportal.guestdiscussion.service.messaging;
...
import ir.ac.iut.sccportal.guestdiscussion.service.CommentServiceUtil;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			PortletTitleLocalServiceUtil.clearService();

			PortletTitleServiceUtil.clearService();
			TitleLocalServiceUtil.clearService();

			TitleServiceUtil.clearService();
		}
	}
}